...
/**
 * -(CALayer*)createTopBorderWithHeight 返回一个layer
 * -(UIView*)createViewBackedTopBorderWithHeight 返回一个View
 * -(void)addTopBorderWithHeight  添加一个layer
 * -(void)addViewBackedTopBorderWithHeight 添加一个View
 */
